...
_0x0:
	...
	.DB  0x31,0x66,0x2C,0x20,0x22,0x73,0x69,0x6E
	.DB  0x79,0x61,0x6C,0x22,0x3A,0x25,0x30,0x2E
	.DB  0x31,0x66,0x7D,0xD,0xA,0x0,0x25,0x30
	.DB  0x2E,0x31,0x66,0x20,0x25,0x30,0x2E,0x31
	.DB  0x66,0x20,0x25,0x30,0x2E,0x31,0x66,0xA
	.DB  0x0,0x20,0x56,0x20,0x20,0x20,0x20,0x49
	.DB  0x20,0x20,0x20,0x20,0x20,0x53,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 00F3 sprintf(lcd_buffer,"%0.1f %0.1f %0.1f\n", vinput,current,sinyal);
	...
	CALL _sprintf
	ADIW R28,16
; 0000 00F4 sprintf(lcd_buffer2," V    I     S");
