...
_0x0:
	.DB  0x7B,0x22,0x61,0x75,0x74,0x68,0x22,0x3A
	.DB  0x22,0x6A,0x72,0x34,0x4A,0x5A,0x62,0x44
	.DB  0x76,0x6B,0x50,0x4F,0x49,0x2D,0x36,0x43
	.DB  0x37,0x52,0x61,0x31,0x35,0x55,0x54,0x76
	.DB  0x5A,0x73,0x59,0x73,0x49,0x78,0x6B,0x59
	.DB  0x43,0x22,0x2C,0x22,0x73,0x73,0x69,0x64
	.DB  0x22,0x3A,0x22,0x57,0x41,0x4B,0x41,0x4E
	.DB  0x44,0x41,0x22,0x2C,0x22,0x70,0x61,0x73
	.DB  0x73,0x22,0x3A,0x22,0x6A,0x6F,0x6D,0x62
	.DB  0x6C,0x6F,0x65,0x6C,0x69,0x74,0x22,0x7D
	.DB  0x0,0x7B,0x22,0x76,0x6F,0x6C,0x74,0x61
	.DB  0x67,0x65,0x22,0x3A,0x25,0x30,0x2E,0x31
	.DB  0x66,0x2C,0x20,0x22,0x63,0x75,0x72,0x72
	.DB  0x65,0x6E,0x74,0x22,0x3A,0x25,0x30,0x2E
	.DB  0x30,0x31,0x66,0x2C,0x20,0x22,0x73,0x69
	.DB  0x6E,0x79,0x61,0x6C,0x22,0x3A,0x25,0x30
	.DB  0x2E,0x31,0x66,0x7D,0xD,0xA,0x0,0x25
	.DB  0x30,0x2E,0x31,0x66,0x20,0x25,0x30,0x2E
	.DB  0x31,0x66,0x20,0x25,0x30,0x2E,0x31,0x66
	.DB  0xA,0x0,0x20,0x56,0x20,0x20,0x20,0x20
	.DB  0x49,0x72,0x20,0x20,0x20,0x20,0x20,0x53
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 00D3    delay_ms(1000);
	CALL SUBOPT_0x0
; 0000 00D4    printf("{\"auth\":\"jr4JZbDvkPOI-6C7Ra15UTvZsYsIxkYC\",\"ssid\":\"WAKANDA\",\"pass\":\"jombloelit\"}");
; 0000 00D5   delay_ms(1000);
	CALL SUBOPT_0x0
; 0000 00D6    printf("{\"auth\":\"jr4JZbDvkPOI-6C7Ra15UTvZsYsIxkYC\",\"ssid\":\"WAKANDA\",\"pass\":\"jombloelit\"}");
...
_0x8:
; 0000 00DB 
; 0000 00DC  float a = 90.0,b=10.0;
; 0000 00DD       current = 1.2;
	SBIW R28,8
	CALL SUBOPT_0x1
	LDI  R30,LOW(32)
	STD  Y+2,R30
...
; 0000 00DE 
; 0000 00DF 
; 0000 00E0  // vcc = 5v ; adc 10 bit = 1024 desimal
; 0000 00E1  //sprintf(lcd_buffer,"Volt :%0.0001f V",vinput);
; 0000 00E2 
; 0000 00E3 
; 0000 00E4 //sprintf(lcd_buffer,"Current :%0.0001f A",current);
; 0000 00E5 
; 0000 00E6 
; 0000 00E7 // printf("%0.1f %0.1f %0.1f %0.1f\r\n", vinput,current,a,b);
; 0000 00E8 //printf("%0.0002f",dataadc);
; 0000 00E9  dataadc=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00EA //if(dataadc<600)dataadc = 0;
; 0000 00EB 
; 0000 00EC vinput=((float)(dataadc*17)/700);
	MOVW R30,R4
	LDI  R26,LOW(17)
	LDI  R27,HIGH(17)
	CALL __MULW12
	...
	STS  _vinput+2,R22
	STS  _vinput+3,R23
; 0000 00ED sinyal = vinput/19.3*100;
	LDS  R26,_vinput
	LDS  R27,_vinput+1
	LDS  R24,_vinput+2
	LDS  R25,_vinput+3
...
; 0000 00EE if(sinyal>100){
	...
	BRCC PC+3
	JMP  _0xB
; 0000 00EF sinyal =100;
	CALL SUBOPT_0x4
; 0000 00F0 }
; 0000 00F1 
; 0000 00F2 for ( count = 0; count <= 1000; count++){
_0xB:
	CLR  R8
	CLR  R9
_0xD:
	...
	CPC  R31,R9
	BRLT _0xE
; 0000 00F3     adc1 = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOVW R6,R30
; 0000 00F4     if ( adc1 > dataMax ) dataMax = adc1;
	__CPWRR 12,13,6,7
	BRGE _0xF
	MOVW R12,R6
; 0000 00F5             if ( adc1 < dataMin ) dataMin = adc1;
_0xF:
	__CPWRR 6,7,10,11
	BRGE _0x10
	MOVW R10,R6
...
_0xE:
; 0000 00F8 
; 0000 00F9     vout1 = dataMax*(5.0/1023);
	MOVW R30,R12
	CALL SUBOPT_0x3
	__GETD2N 0x3BA0280A
	CALL __MULF12
	...
	STS  _vout1+2,R22
	STS  _vout1+3,R23
; 0000 00FA       //arus1 = fabs(vout1-2.50)/0.066;
; 0000 00FB       arus1 = fabs(vout1-2.50)/0.066;
	__GETD2N 0x40200000
	CALL __SUBF12
	MOVW R26,R30
	MOVW R24,R22
...
; 0000 00FC       arus1 = arus1/3;
	...
	__GETD1N 0x40400000
	CALL SUBOPT_0x6
; 0000 00FD       current = arus1;
	LDS  R30,_arus1
	LDS  R31,_arus1+1
	LDS  R22,_arus1+2
	LDS  R23,_arus1+3
	CALL SUBOPT_0x2
; 0000 00FE       if(current>10){
	LDS  R26,_current
	LDS  R27,_current+1
	LDS  R24,_current+2
	LDS  R25,_current+3
...
; 0000 00FF       current = 0;}
	...
	STS  _current+3,R30
; 0000 0100 
; 0000 0101      // adc1 = read_adc(1);
; 0000 0102 printf("{\"voltage\":%0.1f, \"current\":%0.01f, \"sinyal\":%0.1f}\r\n",vinput,current,sinyal);
_0x11:
	__POINTW1FN _0x0,81
	CALL SUBOPT_0x8
	CALL _printf
	ADIW R28,14
; 0000 0103 sprintf(lcd_buffer,"%0.1f %0.1f %0.1f\n", vinput,current,sinyal);
	...
	CALL _sprintf
	ADIW R28,16
; 0000 0104 sprintf(lcd_buffer2," V    Ir     S");
...
; 0000 0105 lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0106 lcd_puts(lcd_buffer2);
...
; 0000 0107 lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0108 lcd_puts(lcd_buffer);
	LDI  R26,LOW(_lcd_buffer)
	LDI  R27,HIGH(_lcd_buffer)
	RCALL _lcd_puts
; 0000 0109 //printf("{\"auth\":\"jr4JZbDvkPOI-6C7Ra15UTvZsYsIxkYC\",\"ssid\":\"WAKANDA\",\"pass\":\"jombloelit\"}");
; 0000 010A delay_ms(5000);
	LDI  R26,LOW(5000)
	LDI  R27,HIGH(5000)
	CALL _delay_ms
; 0000 010B 
